...
export function Hero() {
  ...
  const businessConnectors = [
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-full h-full p-1.5" fill="#000000">
          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-3 15.5l-2.5-7h2.2l1.4 4.5h.2l1.4-4.5h2.2l-2.5 7h-2.4z"/>
        </svg>
      ), 
      category: "Voice" 
    },
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-full h-full p-1.5" fill="#000000">
          <path d="M4 11h2v3H4v-3zm3.5-3h2v9h-2V8zm3.5 2h2v5h-2v-5zm3.5-1h2v7h-2v-7zm3.5 2h2v3h-2v-3z"/>
        </svg>
      ), 
      category: "Voice AI" 
    },
