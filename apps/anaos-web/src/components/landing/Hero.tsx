...
export function Hero() {
  ...
  const businessConnectors = [
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-full h-full p-1.5" fill="#F22F46">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.3 12.3c-.6.6-1.5.6-2.1 0l-2.2-2.2c-.6-.6-.6-1.5 0-2.1l2.2-2.2c.6-.6 1.5-.6 2.1 0 .6.6.6 1.5 0 2.1l-1.1 1.1 1.1 1.1c.6.6.6 1.5 0 2.1zM9.7 14.3c-.6.6-1.5.6-2.1 0-.6-.6-.6-1.5 0-2.1l1.1-1.1-1.1-1.1c-.6-.6-.6-1.5 0-2.1.6-.6 1.5-.6 2.1 0l2.2 2.2c.6.6.6 1.5 0 2.1l-2.2 2.2z"/>
        </svg>
      ), 
      category: "SMS" 
    },
    { 
      name: "Vapi AI", 
      icon: (
        <svg viewBox="0 0 24 24" className="w-full h-full p-1.5" fill="#000000">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 14.5h-2v-4h-2v-3h2V8h2v1.5h2v3h-2v4z"/>
        </svg>
      ), 
      category: "Voice" 
    },
